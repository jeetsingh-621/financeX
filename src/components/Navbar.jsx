  ...
  return (
    <div className="navbar  w-full sticky z-[999] bg-[#151515] top-0 px-4 py-4 sm:py-7 flex items-center justify-between">
      ...
      <div onClick={toggleNavBar} className=" sm:hidden z-[2000] ">
        ...
        >
          <span
            className={`bg-white ms-auto h-[3px] rounded-xl duration-500 ${showNavBar ? "w-6 rotate-45 translate-y-[11px]" : "w-5"
              }`}
          ></span>
          <span
            className={`bg-white h-[3px] rounded-xl duration-500 ${showNavBar ? "w-0" : "w-7"
              }`}
          ></span>
          <span
            className={`bg-white ms-auto h-[3px] rounded-xl duration-500 ${showNavBar ? "w-6 -rotate-45 -translate-y-[10px]" : "w-5"
              }`}
          ></span>
        </div>
      </div>
      ...
      <div
        className={`flex flex-col min-h-[100vh]   bg-[#151515] items-center justify-center gap-4 sm:gap-6 font-semibold  sm:hidden fixed transition-all duration-300 bg-ebony ${showNavBar
